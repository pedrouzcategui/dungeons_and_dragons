...
INSERT INTO dialogue_options (dialogue_id, text, next_dialogue_id, next_chapter_id)
VALUES
(1, 'Beans', 2, NULL), -- Option 1: Leads to Dialogue 2
(1, 'Eggs', 3, NULL);  -- Option 2: Leads to Dialogue 3
...
-- Update Options to Transition to Chapter 2
UPDATE dialogue_options
SET next_chapter_id = 2
WHERE next_dialogue_id IN (2, 3);
